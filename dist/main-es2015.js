...
let RegisterComponent = class RegisterComponent {
    ...
    GuargarUser() {
        let usuario = new _models_usuarios_models__WEBPACK_IMPORTED_MODULE_4__["Usuario"](this.forma.value.user, this.forma.value.password, this.forma.value.email);
...
const URL_SERVICIO = 'http://localhost:3000';
...
class Pedido {
    constructor(user, fecha, valor, status, Iduser) {
        this.user = user;
        this.fecha = fecha;
        this.valor = valor;
        this.status = status;
...
let AddpedidoComponent = class AddpedidoComponent {
    ...
    guardarDatos(forma) {
        ...
        const pedido = new _models_pedido_models__WEBPACK_IMPORTED_MODULE_2__["Pedido"](this.usuario[0].user, this.fecha2, forma.value.valor, status, this.termino);
...
const PAGES_ROUTES = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(pagesRouter);
...
let PreviousComponent = class PreviousComponent {
    ...
    cargarusuarios(termino) {
        this.usuarioService.cargarUsuarioId(termino).subscribe((resp) => { this.usuario = resp; });
...
let DataPerfilService = class DataPerfilService {
    ...
    creardataPerfil(dataperfil, usuario) {
        const url = _config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIO"] + '/dataperfil/addDataPerfil/' + usuario[0].Iduser;
...
let HeaderComponent = class HeaderComponent {
    constructor(usuarioService, router, mainLista) {
        this.usuarioService = usuarioService;
        this.router = router;
